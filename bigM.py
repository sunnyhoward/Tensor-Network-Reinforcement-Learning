...
def DRMG(M,p0,policy,W1,W,copy2,MT,WT,flatstate,T,flatreward):
    ...
    #st-11,st-12,a1,a2
    temp1 = np.tensordot(temp1,output2,((1,2,6),(0,1,2))) 
...
def plotgreedy(policy,T,p0,M,MT,copy2):
   state = p0
...
if __name__ == '__main__': 
    ...
    er = contracteverything(M, p0, policy, W1, W, copy2, MT, WT, flatstate)
    policy = DRMG(M,p0,policy,W1,W,copy2,MT,WT,flatstate,T)
    er2 = contracteverything(M, p0, policy, W1, W, copy2, MT, WT, flatstate)
    plotgreedy(policy,T,p0,M,MT,copy2)