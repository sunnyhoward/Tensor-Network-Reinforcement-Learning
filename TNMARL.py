...
def createM1(noS,prob1,prob2):
    ...
    M[1,0,0,0,2]=prob1+prob2 #if jump down from second last
    M[1,0,1:,0,4]=prob1+prob2 #if jump down from second last
    ...
    M[int((noS+1)/2 -3),int((noS+1)/2 -2),0:int((noS+1)/2 -1) ,1,2]=prob1
    M[int((noS+1)/2 -3),int((noS+1)/2 -2),int((noS+1)/2 -1):,1,4]=prob1

    M[int((noS+1)/2 -3),int((noS+1)/2 -3),0:int((noS+1)/2 -2) ,1,2]=prob2
    M[int((noS+1)/2 -3),int((noS+1)/2 -3),int((noS+1)/2 -2): ,1,4]=prob2

    
    M[int((noS+1)/2 -3),int((noS+1)/2 -1),0:int((noS+1)/2),1,1]=prob2
    M[int((noS+1)/2 -3),int((noS+1)/2 -1),int((noS+1)/2):,1,3]=prob2
    ...
    M[int((noS+1)/2 -2),int((noS+1)/2-1),0:int((noS+1)/2),1,1]=prob1
    M[int((noS+1)/2 -2),int((noS+1)/2-1),int((noS+1)/2):,1,3]=prob1

    M[int((noS+1)/2 -2),int((noS+1)/2),0:int((noS+1)/2)+1 ,1,1]=prob2
    M[int((noS+1)/2 -2),int((noS+1)/2),(int((noS+1)/2)+1): ,1,3]=prob2

    M[int((noS+1)/2 -2),int((noS+1)/2 -2),0:int((noS+1)/2 -1),1,2]=prob2  
    M[int((noS+1)/2 -2),int((noS+1)/2 -2),int((noS+1)/2 -1):,1,4]=prob2  
    ...
    M[int((noS+1)/2),int((noS+1)/2)-2,0:(int((noS+1)/2)-1),0,2] = prob2
    M[int((noS+1)/2),int((noS+1)/2)-2,(int((noS+1)/2)-1):,0,4] = prob2
    ...
    M[int(noS-2),int(noS-2),0:int(noS-1),1,1] = prob2 #if jump up from 2nd top cell then stay same
    M[int(noS-2),int(noS-2),int(noS-1),1,3] = prob2 #if jump up from 2nd top cell then stay same

    
    M[int(noS-2),int(noS-1),:,1,1] = prob1+prob2 #if jump up from 2nd top cell then go up 1
    
    
    M[int(noS-2),int(noS-3),0:int(noS-2),0,1] = prob1 #if go down from 2nd top cell then go down 
    M[int(noS-2),int(noS-3),int(noS-2):,0,3] = prob1 #if go down from 2nd top cell then go down 

    
    M[int(noS-2),int(noS-2),0:int(noS-1),0,1] = prob2 #if go down from 2nd top cell then go down 
    M[int(noS-2),int(noS-2),int(noS-1),0,3] = prob2 #if go down from 2nd top cell then go down 

    
    M[int(noS-2),int(noS-4),0:int(noS-3),0,1] = prob2 #if go down from 2nd top cell then go down 
    M[int(noS-2),int(noS-4),int(noS-3):,0,3] = prob2 #if go down from 2nd top cell then go down 


    M[int(noS-1),int(noS-1),:,1,1] = 1 #if jump up from top cell then stay same
    
    M[int(noS-1),int(noS-2),0:int(noS-1),0,1] = prob1 #if jump down from  top cell then go down
    M[int(noS-1),int(noS-2),int(noS-1),0,3] = prob1 #if jump down from  top cell then go down

    
    M[int(noS-1),int(noS-3),0:int(noS-2),0,1] = prob2 #if jump down from  top cell then go 
    M[int(noS-1),int(noS-3),int(noS-2):,0,3] = prob2 #if jump down from  top cell then go 
...
def createM2(noS,prob1,prob2):
    ...
    #if in state -2, if we go up 2 we get reward = 0
    M[int((noS+1)/2 -3),int((noS+1)/2 -2),0:int((noS+1)/2 -2) ,1,4]=prob1
    M[int((noS+1)/2 -3),int((noS+1)/2 -2),int((noS+1)/2 -2):,1,2]=prob1

    M[int((noS+1)/2 -3),int((noS+1)/2 -3),0:int((noS+1)/2 -3) ,1,4]=prob2
    M[int((noS+1)/2 -3),int((noS+1)/2 -3),int((noS+1)/2 -3): ,1,2]=prob2

    
    M[int((noS+1)/2 -3),int((noS+1)/2 -1),0:int((noS+1)/2-1),1,3]=prob2
    M[int((noS+1)/2 -3),int((noS+1)/2 -1),int((noS+1)/2-1):,1,1]=prob2
    ...
    M[int((noS+1)/2 -2),int((noS+1)/2-1),0:int((noS+1)/2-1),1,3]=prob1
    M[int((noS+1)/2 -2),int((noS+1)/2-1),int((noS+1)/2-1):,1,1]=prob1

    M[int((noS+1)/2 -2),int((noS+1)/2),0:int((noS+1)/2) ,1,3]=prob2
    M[int((noS+1)/2 -2),int((noS+1)/2),(int((noS+1)/2)): ,1,1]=prob2

    M[int((noS+1)/2 -2),int((noS+1)/2 -2),0:int((noS+1)/2 -2),1,4]=prob2  
    M[int((noS+1)/2 -2),int((noS+1)/2 -2),int((noS+1)/2 -2):,1,2]=prob2  
    ...
    M[int((noS+1)/2),int((noS+1)/2)-2,0:(int((noS+1)/2)-2),0,4] = prob2
    M[int((noS+1)/2),int((noS+1)/2)-2,(int((noS+1)/2)-2):,0,2] = prob2
    ...
    M[int(noS-2),int(noS-2),0:int(noS-2),1,3] = prob2 #if jump up from 2nd top cell then stay same
    M[int(noS-2),int(noS-2),int(noS-2),1,1] = prob2 #if jump up from 2nd top cell then stay same

    
    M[int(noS-2),int(noS-1),0:int(noS-1),1,3] = prob1+prob2 #if jump up from 2nd top cell then go up 1
    M[int(noS-2),int(noS-1),int(noS-1),1,1] = prob1+prob2 #if jump up from 2nd top cell then go up 1

    
    M[int(noS-2),int(noS-3),0:int(noS-3),0,3] = prob1 #if go down from 2nd top cell then go down 
    M[int(noS-2),int(noS-3),int(noS-3):,0,1] = prob1 #if go down from 2nd top cell then go down 

    
    M[int(noS-2),int(noS-2),0:int(noS-2),0,3] = prob2 #if go down from 2nd top cell then go down 
    M[int(noS-2),int(noS-2),int(noS-2):,0,1] = prob2 #if go down from 2nd top cell then go down 

    
    M[int(noS-2),int(noS-4),0:int(noS-4),0,3] = prob2 #if go down from 2nd top cell then go down 
    M[int(noS-2),int(noS-4),int(noS-4):,0,1] = prob2 #if go down from 2nd top cell then go down 


    M[int(noS-1),int(noS-1),0:int(noS-1),1,3] = 1 #if jump up from top cell then stay same
    M[int(noS-1),int(noS-1),int(noS-1),1,1] = 1 #if jump up from top cell then stay same


    M[int(noS-1),int(noS-2),0:int(noS-2),0,3] = prob1 #if jump down from  top cell then go down
    M[int(noS-1),int(noS-2),int(noS-2):,0,1] = prob1 #if jump down from  top cell then go down

    
    M[int(noS-1),int(noS-3),0:int(noS-3),0,3] = prob2 #if jump down from  top cell then go 
    M[int(noS-1),int(noS-3),int(noS-3):,0,1] = prob2 #if jump down from  top cell then go 

    
    M[int(noS-1),int(noS-1),0:int(noS-1),0,3] = prob2 #if jump down from  top cell then go down
    M[int(noS-1),int(noS-1),int(noS-1),0,1] = prob2 #if jump down from  top cell then go down
